...
public class Families2Persons {
	...
	public Families2Persons() throws IOException {
		...
		//EPackage.Registry.INSTANCE.put(getMetamodelUri("Persons"), org.eclipse.emf.ecore.EcorePackage.eINSTANCE);
		//EPackage.Registry.INSTANCE.put(getMetamodelUri("Families"), org.eclipse.emf.ecore.EcorePackage.eINSTANCE);
	...
	protected String getMetamodelUri(String metamodelName) {
		String uriString = properties.getProperty("Families2Persons.metamodels." + metamodelName);
		try {
